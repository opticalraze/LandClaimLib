...
import com.opticalraze.landclaimlib.visualization.Boundary;
...
import com.opticalraze.landclaimlib.Events.BoundaryVisualizationEvent;
...
public class Visualization
{
    ...
    public static void Revert(Player player)
    {
        if (player != null && player.isOnline())
            LandClaimLib.instance.dataStore.getPlayerData(player.getUniqueId()).setVisibleBoundaries(null);
    }
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public static Visualization FromClaim(Claim claim, int height, com.opticalraze.landclaimlib.VisualizationType visualizationType, Location locality)
    {
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public void addClaimElements(Claim claim, int height, com.opticalraze.landclaimlib.VisualizationType visualizationType, Location locality)
    {
    ...
    public void addClaimElements(Location min, Location max, Location locality, int height, BlockData cornerBlockData, BlockData accentBlockData, int STEP) {
        this.boundaries.add(new Boundary(new BoundingBox(min, max), com.opticalraze.landclaimlib.VisualizationType.ofBlockData(accentBlockData)));
    }
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public static Visualization fromClaims(Iterable<Claim> claims, int height, com.opticalraze.landclaimlib.VisualizationType type, Location locality)
    {
        Visualization visualization = new Visualization();
