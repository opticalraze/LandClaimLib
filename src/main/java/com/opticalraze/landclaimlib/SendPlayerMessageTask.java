...
class SendPlayerMessageTask implements Runnable
{
    ...
    public void run()
    {
        ...
        {
            PlayerData playerData = LandClaimLib.instance.dataStore.getPlayerData(this.player.getUniqueId());
        ...
        {
            LandClaimLib.sendMessage(this.player, this.color, this.message);
        }
    }
}
