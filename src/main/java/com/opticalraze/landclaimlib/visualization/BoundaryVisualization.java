package com.opticalraze.landclaimlib.visualization;

import com.opticalraze.landclaimlib.Claim;
import com.opticalraze.landclaimlib.CustomLogEntryTypes;
import com.opticalraze.landclaimlib.LandClaimLib;
import com.opticalraze.landclaimlib.PlayerData;
import com.opticalraze.landclaimlib.Events.BoundaryVisualizationEvent;
import com.opticalraze.landclaimlib.Utils.IntVector;
        ...
        public void run()
        {
            ...
            catch (Exception exception)
            {
                if (event.getProvider() == BoundaryVisualizationEvent.DEFAULT_PROVIDER)
                {
                    ...
                    LandClaimLib.instance.getLogger().log(Level.WARNING, "Exception visualizing claim", exception);
                    return;
                }
                ...
                LandClaimLib.instance.getLogger().log(
                        Level.WARNING,
