...
class AutoExtendClaimTask implements Runnable
{
            ...
            int lowestExistingY)
    {
        ...
        this.minY = Math.max(
                ...
                LandClaimLib.instance.config_claims_maxDepth);
    }
    ...
    public void run()
    {
        ...
        {
            Bukkit.getScheduler().runTask(LandClaimLib.instance, new ExecuteExtendClaimTask(claim, newY));
        }
    }
    ...
    private record ExecuteExtendClaimTask(Claim claim, int newY) implements Runnable
    {
        ...
        public void run()
        {
            LandClaimLib.instance.dataStore.extendClaim(claim, newY);
        }
    }
