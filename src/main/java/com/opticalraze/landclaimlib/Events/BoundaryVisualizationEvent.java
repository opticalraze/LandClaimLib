...
import com.opticalraze.landclaimlib.visualization.VisualizationProvider;
import com.opticalraze.landclaimlib.visualization.impl.AntiCheatCompatVisualization;
import com.opticalraze.landclaimlib.visualization.impl.FakeBlockVisualization;
...
public class BoundaryVisualizationEvent extends PlayerEvent
{
    ...
    {
        if (LandClaimLib.instance.config_visualizationAntiCheatCompat)
        {
